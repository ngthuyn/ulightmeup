...
export default function GalleryPage() {
  ...
  return (
    <PageShell videoSrc="/videos/light-intro.mp4">
      <main className="site-bg relative min-h-[100svh] overflow-hidden text-zinc-900">
        {flash && (
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-4 rounded-full px-4 py-3">
            <Link
              href="/"
              className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-4 py-2 text-sm font-semibold text-zinc-800 transition hover:-translate-y-0.5 hover:bg-zinc-50"
            >
              ← 🏠
            </Link>
...
/>
                ...
                <div className="camera-burst">
                  ...
                  <p
                  className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-xs tracking-[0.3em] text-zinc-500"
                >
                  OPEN ARCHIVE
                </p>
              </div>
