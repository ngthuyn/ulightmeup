...
useEffect(() => {
  ...
  return (
<main className="relative min-h-[100svh] overflow-x-hidden site-bg text-zinc-900">     
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.92)_0%,rgba(255,255,255,0.72)_24%,rgba(255,255,255,0.42)_100%)]" />
<div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(59,130,246,0.03)_1px,transparent_1px),linear-gradient(rgba(59,130,246,0.03)_1px,transparent_1px)] bg-[size:72px_72px] opacity-10" />        
        <div className="absolute left-[-8%] top-[-10%] h-[26rem] w-[26rem] rounded-full bg-sky-300/35 blur-3xl" />
        <div className="absolute right-[-10%] top-[12%] h-[24rem] w-[24rem] rounded-full bg-cyan-300/25 blur-3xl" />
        {/*<div className="absolute left-[12%] bottom-[-14%] h-[26rem] w-[26rem] rounded-full bg-blue-200/40 blur-3xl" />
        <div className="absolute right-[10%] bottom-[8%] h-[18rem] w-[18rem] rounded-full bg-sky-200/40 blur-3xl" />
     */}
        </div>
...
<div className="relative mx-auto mt-5 grid max-w-6xl gap-6 pb-4 lg:grid-cols-[1fr_1fr] lg:items-center lg:pb-0">       <div className="relative order-1 lg:order-1">
        <div className="text-center text-sky-700/70">
...
<div className="mt-8 mx-auto max-w-md">
  <div className="h-[150px] rounded-[2rem] border border-white/60 bg-white/70 p-5 shadow-[0_18px_40px_rgba(0,0,0,0.08)] backdrop-blur-xl">
    
    <div className="flex h-full flex-col justify-center">
      <p className="text-center text-lg italic leading-8 text-zinc-700">
        "{fanQuotes[quoteIndex]}"
      </p>

      <p className="mt-3 text-right text-sm text-sky-700/60">
        — Lài tì lái ti ✨
      </p>
    </div>
...
<div className="relative z-30 mt-2 pb-4 text-center">  
  ...
  src="/images/u lighT me up.png"
    alt="u lighT me up"
    className="mx-auto w-[320px] sm:w-[400px] opacity-90"
  />
    ...
    {bottomIcons
      ...
      .map((item) => (
        <Link
          key={item.href}
          href={item.href}
className="flex h-11 w-11 items-center justify-center rounded-full border border-sky-200/50 bg-sky-100/80 text-xl shadow-lg backdrop-blur-xl transition hover:scale-110"
>
          {item.icon}
        </Link>
      ))}
...
<div className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] left-5 z-50"> 
  ...
  >
<div className="absolute -top-3.5 left-1/2 -translate-x-1/2 whitespace-nowrap text-[9px] font-semibold text-sky-600">  
  💌 lai-ti yaaah
</div>
...
<div className="relative">
  ...
  <button
    ...
    className="relative flex h-11 w-11 items-center justify-center rounded-full border border-sky-300/50 bg-sky-200/90 text-lg shadow-xl backdrop-blur-xl transition hover:scale-110"
  >
    {menuOpen ? "✕" : "🏠"}
  </button>
</div>
...
{wishOpen && (
  <div className="fixed bottom-20 left-4 z-[60] w-[280px]">
    <div className="rounded-3xl border border-white/60 bg-white/95 p-5 shadow-2xl backdrop-blur-xl">
      ...
      <p className="text-sm leading-7 text-zinc-700">
        Chúc lighT luôn thật hạnh phúc, khỏe mạnh và tiếp tục tỏa sáng theo cách riêng của mình. tinie sẽ luôn ở đây, cùng đồng hành và yêu thương lighT thật nhiều 💙✨
      </p>
